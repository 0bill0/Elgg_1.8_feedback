...
$feedback_url = $vars['url'] . "action/feedback/submit_feedback?&__elgg_token=$token&__elgg_ts=$ts";
	...
	$open_img = '<img src="'.$CONFIG->wwwroot.'mod/feedback/_graphics/slide-button-open-'.$idioma.'.gif" alt="'.elgg_echo('feedback:label').'" title="'.elgg_echo('feedback:label').'" />';
	$close_img = '<img src="'.$CONFIG->wwwroot.'mod/feedback/_graphics/slide-button-close-'.$idioma.'.gif" alt="'.elgg_echo('feedback:label').'"	title="'.elgg_echo('feedback:label').'" />';
?>
